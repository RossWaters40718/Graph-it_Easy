...
# ****************************** Channel 2 ******************************
    ...
    def plot_legends(plt_num,color,text=None):
        if plt_num==1:
            ...
            textstr = '\n'.join(text)
            ax.text(1.005, 1.0, textstr, color=color,transform=ax.transAxes, fontsize=9,verticalalignment='top', bbox=props)
        elif plt_num==2:
            if text==None:
                text=[]
            ...
            props = dict(boxstyle='round', facecolor=Graph_Color.get(),edgecolor=color)
            textstr = '\n'.join(text)
            ax.text(1.005, 0.6, textstr, color=color,transform=ax.transAxes, fontsize=9,verticalalignment='top', bbox=props)
    def stamp_time():
