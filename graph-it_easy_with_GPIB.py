...
class Test():
    def log(exe_style):# Example
        ...
        if exe_style=='loop':Title.set("X Scale = Log, Draw Style = Update Using Loop")
        elif exe_style=='instant':Title.set("X Scale = Log, Draw Style = Update Using Instant")
...
# ****************************** Plot 1 ******************************
        ...
        legend_text=['Plot 1','Pts. = '+str(num_pts),'FPS = '+fps,'Style = '+exe_style,'Max. = '+ymax+'dB','Min. = '+ymin+'dB']# Max Strings = 10    
        Test.plot_legends(plt_num,plt1_color,legend_text)
        canvas.draw()
# ****************************** Plot 2 ******************************
        ...
        Test.plot_legends(plt_num,plt2_color,legend_text)
        Test.stamp_time()
        canvas.draw()
    def linear(exe_style):# Example
        clear_graph() # Always Call clear_graph() To Start Fresh.
        if exe_style=='loop':Title.set('X Scale = Linear, Draw Style = Update Using Loop')
        elif exe_style=='instant':Title.set('X Scale = Linear, Draw Style = Update Using Instant')
...
# ****************************** Plot 1 ******************************
        ...
        if exe_style=='loop':
            ...
            t_1=timeit.default_timer()-t_0    
            fps=str(int(frames/t_1))
        ymax=str(round(max(ydata),2))# Max Y Value In List        
        ymin=str(round(min(ydata),2))# Max Y Value In List        
        legend_text=['Plot 1','Pts. = '+str(num_pts),'FPS = '+fps,'Style = '+exe_style,'Max. = '+ymax+'ma','Min. = '+ymin+'ma']    
        Test.plot_legends(plt_num,plt1_color,legend_text)
        canvas.draw()
# ****************************** Plot 2 ******************************
        ...
        ymax=str(round(max(ydata),2))# Max Y Value In List        
        ymin=str(round(min(ydata),2))# Max Y Value In List        
        legend_text=['Plot 2','Pts. = '+str(num_pts),'FPS = '+fps,'Style = '+exe_style,'Max. = '+ymax+'ma','Min. = '+ymin+'ma']    
        Test.plot_legends(plt_num,plt2_color,legend_text)
        Test.stamp_time()
        canvas.draw()
    def plot_tds210_curves(exe_style):# Example
        ...
        # Clear Locs And Labels Incase Old Saved File Is Overwritten
        X_Tick_Locs.set("")
        X_Tick_Lbls.set("")
        Y_Tick_Locs.set("")
        Y_Tick_Lbls.set("")
...
# ****************************** Channel 1 ******************************
        ...
        legend_text=[source,'Pts. = '+str(num_pts),str(round(float(meas1),3))+' Vpk-pk',str(round(float(meas2),3))+' Vrms',str(round(float(meas3),3))+' HZ',str(round(float(meas4),3))+' Sec.','FPS = '+fps]    
        Test.plot_legends(plt_num,plt1_color,legend_text)
        canvas.draw()
# ****************************** Channel 2 ******************************
    ...
    def plot_legends(plt_num,color,text=None):
        if plt_num==1:
            if text==None:
                text=[]
                if Legends1_Source1.get()!="":text.append(Legends1_Source1.get())
                if Legends1_Source2.get()!="":text.append(Legends1_Source2.get())
                if Legends1_Source3.get()!="":text.append(Legends1_Source3.get())
                if Legends1_Source4.get()!="":text.append(Legends1_Source4.get())
                if Legends1_Source5.get()!="":text.append(Legends1_Source5.get())
                if Legends1_Source6.get()!="":text.append(Legends1_Source6.get())
                if Legends1_Source7.get()!="":text.append(Legends1_Source7.get())
                if Legends1_Source8.get()!="":text.append(Legends1_Source8.get())
                if Legends1_Source9.get()!="":text.append(Legends1_Source9.get())
                if Legends1_Source10.get()!="":text.append(Legends1_Source10.get())
            else:
                if 0 < len(text):Legends1_Source1.set(text[0])
                if 1 < len(text):Legends1_Source2.set(text[1])
                if 2 < len(text):Legends1_Source3.set(text[2])
                if 3 < len(text):Legends1_Source4.set(text[3])
                if 4 < len(text):Legends1_Source5.set(text[4])
                if 5 < len(text):Legends1_Source6.set(text[5])
                if 6 < len(text):Legends1_Source7.set(text[6])
                if 7 < len(text):Legends1_Source8.set(text[7])
                if 8 < len(text):Legends1_Source9.set(text[8])
                if 9 < len(text):Legends1_Source10.set(text[9])
            props = dict(boxstyle='round', facecolor=Graph_Color.get(),edgecolor=color)
            textstr = '\n'.join(text)
            ax.text(1.005, 1.0, textstr, color=color,transform=ax.transAxes, fontsize=Legend_Fontsize.get(),verticalalignment='top', bbox=props)
        elif plt_num==2:
            if text==None:
                text=[]
                if Legends2_Source1.get()!="":text.append(Legends2_Source1.get())
                if Legends2_Source2.get()!="":text.append(Legends2_Source2.get())
                if Legends2_Source3.get()!="":text.append(Legends2_Source3.get())
                if Legends2_Source4.get()!="":text.append(Legends2_Source4.get())
                if Legends2_Source5.get()!="":text.append(Legends2_Source5.get())
                if Legends2_Source6.get()!="":text.append(Legends2_Source6.get())
                if Legends2_Source7.get()!="":text.append(Legends2_Source7.get())
                if Legends2_Source8.get()!="":text.append(Legends2_Source8.get())
                if Legends2_Source9.get()!="":text.append(Legends2_Source9.get())
                if Legends2_Source10.get()!="":text.append(Legends2_Source10.get())
            else:
                if 0 < len(text):Legends2_Source1.set(text[0])
                if 1 < len(text):Legends2_Source2.set(text[1])
                if 2 < len(text):Legends2_Source3.set(text[2])
                if 3 < len(text):Legends2_Source4.set(text[3])
                if 4 < len(text):Legends2_Source5.set(text[4])
                if 5 < len(text):Legends2_Source6.set(text[5])
                if 6 < len(text):Legends2_Source7.set(text[6])
                if 7 < len(text):Legends2_Source8.set(text[7])
                if 8 < len(text):Legends2_Source9.set(text[8])
                if 9 < len(text):Legends2_Source10.set(text[9])
            props = dict(boxstyle='round', facecolor=Graph_Color.get(),edgecolor=color)
            textstr = '\n'.join(text)
            ax.text(1.005, 0.6, textstr, color=color,transform=ax.transAxes, fontsize=Legend_Fontsize.get(),verticalalignment='top', bbox=props)
    def stamp_time():
    ...
    def __init__(self,funct,exist=None,file_name=None):
        ...
        def read_ini_data():
            ...
            if self.funct=='load':
                ...
                config.read(self.ini_path)
                keys=["legend1_source1","legend1_source2","legend1_source3","legend1_source4","legend1_source5","legend1_source6",
                      "legend1_source7","legend1_source8","legend1_source9","legend1_source10"]
                for key in keys:
                    try:
                        value=config.get("LEGENDS_1",key)
                        if key=="legend1_source1":Legends1_Source1.set(value)
                        ...
                        elif key=="legend1_source8":Legends1_Source8.set(value)
                        elif key=="legend1_source9":Legends1_Source9.set(value)
                        elif key=="legend1_source10":Legends1_Source10.set(value)
                    except configparser.NoOptionError:
                        pass
                config.read(self.ini_path)
                keys=["legend2_source1","legend2_source2","legend2_source3","legend2_source4","legend2_source5","legend2_source6",
                      "legend2_source7","legend2_source8","legend2_source9","legend2_source10"]
                for key in keys:
                    try:
                        value=config.get("LEGENDS_2",key)
                        if key=="legend2_source1":Legends2_Source1.set(value)
                        ...
                        elif key=="legend2_source8":Legends2_Source8.set(value)
                        elif key=="legend2_source9":Legends2_Source9.set(value)
                        elif key=="legend2_source10":Legends2_Source10.set(value)
                    except configparser.NoOptionError:
                        pass
                config.read(self.ini_path)
        ...
        def write_ini_data():
            ...
            if self.funct=='save':
                ...
                config.set("LEGENDS_1", "legend1_source8", Legends1_Source8.get())
                config.set("LEGENDS_1", "legend1_source9", Legends1_Source9.get())
                config.set("LEGENDS_1", "legend1_source10", Legends1_Source10.get())
                try:
                ...
                config.set("LEGENDS_2", "legend2_source8", Legends2_Source8.get())
                config.set("LEGENDS_2", "legend2_source9", Legends2_Source9.get())
                config.set("LEGENDS_2", "legend2_source10", Legends2_Source10.get())
            try:
...
def load_plot_file(file_name=None):
    ...
    if len(num_plts)>=1:
        for p in arange(1,len(num_plts)+1):
            ...
            ax.draw_artist(line2d)# Draw The Animated Artist (points) From The cached Renderer
            fig.canvas.blit(ax.bbox)# Renderer To The GUI Framework For Visualization
            if p==1:Test.plot_legends(p,color)
            elif p==2:Test.plot_legends(p,color)
    ax.text(-0.15, 1.1, TimeStamp.get(),
            verticalalignment='bottom', horizontalalignment='left',
            transform=ax.transAxes,
            color=Title_Color.get(), fontsize=10)        
...
def about():
    ...
    msg=msg1+msg2
    messagebox.showinfo('About Graph-It Easy With Tektronix TDS 210', msg)
...
if __name__ == "__main__":
    ...
    fig=plt.figure(figsize=(10,10),facecolor='black',frameon=True,dpi=100)
    ax=plt.axes()
    fig.add_axes(ax)
    ...
    canvas.get_tk_widget().pack(fill='both',padx=(0,0),pady=(0,0)) # place Canvas and Toolbar on Tkinter window
    Plot_Data=[]
    ...
    Legends1_Source8=tk.StringVar()
    Legends1_Source9=tk.StringVar()
    Legends1_Source10=tk.StringVar()
    # Plot 2 Legends    
    ...
    Legends2_Source8=tk.StringVar()
    Legends2_Source9=tk.StringVar()
    Legends2_Source10=tk.StringVar()
